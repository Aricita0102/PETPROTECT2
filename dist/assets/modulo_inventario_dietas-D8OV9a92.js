        ...
        <div class="notif-cuerpo" style="padding:24px;">
            <form id="form-editar-dieta-bento" data-id="${e.id}" style="display:flex; flex-direction:column; gap:16px;" novalidate>
                ...
                <div style="display:flex; justify-content:flex-end; margin-bottom: 10px;">
                    <label style="display:flex; align-items:center; gap:8px; cursor:pointer;">
                        <span style="font-size:11px; font-weight:700; color:#64748b; text-transform:uppercase;">Aplica IVA (16%)</span>
                        <input type="checkbox" id="dieta-aplica-iva-bento-edit" ${e.metadata?.aplica_iva===!1?``:`checked`} style="accent-color: #032F40; width: 16px; height: 16px;">
                    </label>
                </div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:14px;">
                    ...
                    <div>
                        <label id="dieta-label-iva-bento-edit" style="display:block; font-size:11px; font-weight:700; color:#64748b; text-transform:uppercase; letter-spacing:0.6px; margin-bottom:7px;">${e.metadata?.aplica_iva===!1?`P. Final (Sin IVA)`:`P. Final (16% IVA inc.)`} <span style="color:#F27405;">*</span></label>
                        <div style="position:relative;">
                            <span style="position:absolute; left:12px; top:11px; color:#64748b; font-weight:600;">$</span>
